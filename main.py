...
def main():
    ...
    axs[0].set_title('Original 256x256 Image')
    axs[0].imshow(cv2.cvtColor(img, cv2.COLOR_BGR2RGB))
    axs[1].set_title('64x64 Image')
    axs[1].imshow(cv2.cvtColor(resized_img, cv2.COLOR_BGR2RGB))
    axs[2].set_title('256x256 Image with Nearest')
    axs[2].imshow(nn_img_algo)
    axs[3].set_title('256x256 Image with OpenCV\'s Nearest')
    axs[3].imshow(nn_img)
    plt.show()
